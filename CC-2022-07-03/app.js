...
//P: new ship with (draft,crew)
//R: see whether the ship is worth looting if the draft of the ship is more than 20 without the crew members on board
//E: given (15,10), return false
//   given (100,20), return true
//   given (50,30), return false
//PC: create a function that checks .thisdraft - this.crew *1.5 >20
function Ship(draft,crew) {
    this.draft = draft;
    this.crew = crew;
