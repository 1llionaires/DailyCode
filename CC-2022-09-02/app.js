...
//P: arr
//R: fill in the array methods to return the correct results
//E: given getLength(arr), results return arr.length
//   given getFirst(arr), results return arr[0]
//   given getLast(arr). results return arr[arr.length-1]
//PC: fill in the methods to get the correct results for the functions
